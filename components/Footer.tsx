        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
          ...
          <div className="flex flex-col gap-6">
            ...
            <div className="flex gap-4">
              <a href="https://www.facebook.com/share/1CnZwze9FQ/" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full border border-gray-700 flex items-center justify-center text-primary hover:bg-primary hover:text-white transition-colors" aria-label="Facebook">
              ...
              <a href="https://www.instagram.com/ausfour_car?igsh=Z2ZneW5kb2RxNG5w" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full border border-gray-700 flex items-center justify-center text-primary hover:bg-primary hover:text-white transition-colors" aria-label="Instagram">
                <svg fill="currentColor" viewBox="0 0 24 24" className="w-5 h-5">
          ...
          <div>
            ...
            <ul className="flex flex-col gap-4 text-gray-400 text-sm font-body">
              <li className="flex items-start gap-3">
                ...
                <span>Nr 366, Lotissement Boustane 2,<br />Oujda 60000, Maroc</span>
              </li>
              <li className="flex items-center gap-3">
                <span className="material-symbols-outlined text-primary">call</span>
                <div className="flex flex-col">
                    <span>+212 643 193 316</span>
                    <span>+212 675 010 606</span>
                    <span>+212 612 100 800</span>
                </div>
              </li>
              <li className="flex items-center gap-3">
                <span className="material-symbols-outlined text-primary">mail</span>
                <span>ausfourcar@gmail.com</span>
              </li>
            </ul>
          </div>
