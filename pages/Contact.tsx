      ...
      <div className="max-w-[1280px] mx-auto px-6 md:px-10 flex flex-col gap-16">
        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-end gap-6 border-b border-border-subtle pb-10">
          ...
          <div className="flex gap-4">
            ...
            <a href="mailto:contact@ausfourcar.ma" className="group flex items-center justify-center w-12 h-12 rounded-full border border-border-subtle hover:border-primary hover:bg-primary/10 transition-all duration-300">
